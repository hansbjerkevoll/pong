...
public class Pong {
	...
	Rectangle paddle = new Rectangle(20,100, Color.BLACK);
	Rectangle ai_paddle = new Rectangle(20, 100, Color.BLACK);
	
	Vector ball_vec = new Vector(15, Math.random()*(Math.PI/4), new Random().nextBoolean(), new Random().nextBoolean());
    ...
    public void start(Stage stage) {
        ...
        score_1.setY(50);
        score_1.setStroke(Color.BLACK);
        score_1.setFill(Color.BLACK);
        score_1.setFont(Font.font("Times New Roman", 50));
        
        score_2.setX(scene.getWidth()/2 + 50);
        score_2.setY(50);
        score_2.setStroke(Color.BLACK);
        score_2.setFill(Color.BLACK);
